...
class UserProvider extends ChangeNotifier {
  ...
  Future<void> _initialize() async {
    ...
    // Auto-sync with server if token exists
  ...
  /// Fetches the full user profile from the Django backend and syncs locally.
  Future<void> fetchProfile() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Map activity_level string → enum
